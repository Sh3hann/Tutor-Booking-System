    ...
    <div className="min-h-screen flex" style={wrapBg}>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center p-12"
        ...
        <div className="relative z-10 text-white text-center max-w-md">
          ...
          <p className="text-xl text-white/80 mb-8">Sign in to continue your learning journey with TutorHub.</p>
          <div className="grid grid-cols-3 gap-4 text-center">
            {[['500+', 'Tutors'], ['10k+', 'Students'], ['4.9★', 'Rating']].map(([val, label]) => (
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className={`backdrop-blur-lg rounded-3xl shadow-2xl p-8 border ${card}`} style={cardStyle}>
            <div className="mb-8">
              <h1 className={`text-3xl font-bold mb-2 ${textPrimary}`}>Student Login</h1>
              <p className={textSub}>Find your perfect tutor today</p>
            </div>
            ...
            <div className="mt-6 text-center space-y-3">
              <p className={`${textLink} text-sm`}>
                ...
                <Link to="/student/signup" className="font-semibold text-[#6C63FF] hover:underline">Sign up free</Link>
              </p>
              <p className={`${textBack} text-sm`}>
                Are you a tutor?{' '}
                <Link to="/tutor/login" className="text-[#3B82F6] hover:underline">Tutor Login</Link>
              </p>
            </div>
          </div>
